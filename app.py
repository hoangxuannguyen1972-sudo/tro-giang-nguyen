...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Xuân Nguyên - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0964156089</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Xuân Nguyên - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0964156089</div>", unsafe_allow_html=True)
